        ...
        tariq = $('.content_managment_table').DataTable({
            ...
            buttons: [{
                ...
                action: function(e, dt, node, config) {
                    datatableSelectedRowsAction(dt, 'configuration/country/city/action', action = 'delete', msg = 'Once deleted, it will deleted all related Data!');
                }
            }],
            select: true,
            columnDefs: [{
        ...
        $(document).on('click', '#content_managment', function(e) {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    $('#modal-loader').hide();
                    _componentCountrySelect2();
                    _componentStateSelect2();
                    _componentCitySelect2();
