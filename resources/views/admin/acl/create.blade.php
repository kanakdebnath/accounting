...
<div class="card border-top-success rounded-top-0" id="table_card">
	<div class="card-header header-elements-inline bg-light border-grey-300" >
		<h5 class="card-title">{{_lang('Role & Permission')}}
		</h5>
    ...
    {!! Form::open(['route' => 'admin.user.role.create', 'id'=>'content_form','files' => true, 'method' => 'POST']) !!}
        ...
        <div class="col-md-4">
          <div class="form-group">
            ...
            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => _lang('Role Name'),'required'=>'']) }}
          </div>
        </div>
        </div>
        <div class="row">
	     ...
	     <table class="table table-bordered">
          ...
          @can('role.create')
		   <div class="text-right">
		    <button type="submit" class="btn btn-primary"  id="submit">{{_lang('Set Permission')}}<i class="icon-arrow-right14 position-right"></i></button>
