    ...
    <fieldset class="mb-3" id="form_field">
     <div class="row">
     	...
     	<div class="col-md-5">
     	  <div class="form-group">
            ...
            {{ Form::text('first_name', null, ['class' => 'form-control', 'placeholder' => _lang('First Name'),'required'=>'']) }}
          </div>
     	</div>
     	...
     	<div class="col-md-5">
     	  <div class="form-group">
            ...
            {{ Form::text('last_name', null, ['class' => 'form-control', 'placeholder' => _lang('last Name'),'required'=>'']) }}
          </div>
     	</div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-md-4">
            ...
            {{ Form::text('username', null, ['class' => 'form-control', 'placeholder' => _lang('Username'),'required'=>'']) }}
          </div>
     	</div>
     </div>
